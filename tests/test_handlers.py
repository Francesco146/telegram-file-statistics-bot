...
def mock_handle_archive():
    ...
    with patch(
        "telegram_file_statistics_bot.handlers.handle_archive",
...
@pytest.mark.asyncio
async def test_handle_file_no_effective_user(
    test_mock_update, test_mock_context
):
...
async def test_handle_file_archive_non_local_mode(
    ...
    test_mock_get_str.return_value = (
